...
## Roadmap  
- [ ] WPM POC  
- [ ] Ideate features and functionality  
- [ ] Trim down to MVP  
- [ ] Functionality POC  
- [ ] Create designs  
- [ ] Implement designs  
...
This app has been created with [Bati](https://batijs.dev) using the following flags: `--react --tailwindcss --authjs --ts-rest --express --prisma --vercel --eslint --prettier`
